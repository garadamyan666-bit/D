...
def backtest_frame(frame: pd.DataFrame, symbol: str, timeframe: str, horizon_bars: int = 12, max_trades: int = 100, cost_bps: float = 10.0) -> dict[str, Any]:
    if len(frame) < 240:
    ...
    candidate_indices = list(range(220, len(frame) - horizon_bars - 1))
